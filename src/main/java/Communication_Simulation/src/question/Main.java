...
public class Main {
	...
	public static void main(String args[]) {
		...
		File inFile = new File("src/main/java/Communication_Simulation/testcases/input_0.txt");  // args[0] is the input file
		File outFile = new File("src/main/java/Communication_Simulation/output/output.txt");  // args[1] is the output file
		try {
