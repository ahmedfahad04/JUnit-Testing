...
public class Account {
    ...
    void set_new_pin(String phone_num, String new_pin){
        ...
        if(phone_num.equals(this.mobile_number)) {
            if(!Objects.equals(new_pin, this.pin)) {
                System.out.println("Mobile number confirmed.");
                this.pin = new_pin;
                System.out.println("Pin setting successful!!");
            } else {
                System.out.println("ERR: You entered your current pin as new pin number!!");
            }
        }
        else System.out.println("ERR: Wrong number. Failed to set new pin.");
    }
